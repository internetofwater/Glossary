...
<h5>Step 2. Click all rows corresponding to terms you believe are synonymous with the term selected in Step 1.</h5> The glossary has provided the 50 terms with the most commonality in the word content of definitions ("score")  to the selected term.
```{r}
...
sel_syn = reactive({distinct(sel_uris()[c(1,input$seltable_rows_selected),])})
