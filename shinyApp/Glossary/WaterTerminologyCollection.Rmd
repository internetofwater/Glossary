...
Here you will find all of the homonyms of the selected term, as well as all synonyms of those homonyms. This displays the eextent to which similar terms are used similarly by different organizations. Terms with the same "Definition Group" are synonyms. Terms without "Definition Groups" have not been assigned any synonyms yet. Please consider helping us improve this Terminology Collection by going to the <b><a href="http://purl.org/iow/glossarybrowser#section-identify-synonyms">Identify Synonyms</a></b> page.
...
#output$select = renderText(u1())
 ...
 output$syntable = DT::renderDataTable({
   DT::datatable(syn_d(), extensions = c('Buttons','Responsive'),options = list(columnDefs = list(list(targets = c(0,3,4,5,6), visible = FALSE),list(targets=c(0,3,4,5,6),searchable=FALSE)),
