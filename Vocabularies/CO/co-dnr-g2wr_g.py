# Title: Colorado - Department of Natural Resources - Guide to(2) Water Rights Glossary
# Created by: Joseph Brewer, WSWC
# Date Created: 05/1/2020
# Purpose: To extract text from html file (website) and export to xlsx file.
# Notes: # CO DNR Division of Water Resources "Guide to Well Permits, Water Rights, and Water Administration.
...
#Retrieving Document
############################################################################
document = Document('co-dnr-g2wr_g.docx')
...
glossary.to_excel('co-dnr-g2wr_g.xlsx')
