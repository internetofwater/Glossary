# Title: Colorado - Colorado Foundation for Water Education - Citizen's Guide to Colorado Water Law
...
#Retrieving Document
############################################################################
document = Document('co-cfwe-cwl_g.docx')
...
glossary.to_excel('co-cfwe-cwl_g.xlsx')  #ToDo: un-comment to run again
