# Title: Alaska - Department of Environmental Conservation- EPA's Clean Water Act Glossary
...
workingDir="/Users/augustus/Desktop/WSWC/IoW/Vocabularies/AK/"
os.chdir(workingDir)


#Retrieving Document
############################################################################
document = Document('ak-dec-cwa_g.docx')
...
glossary.to_excel('ak-dec-cwa_g_EXPORT.xlsx')  #ToDo: un-comment to run again
