# Title: Kansas - Department of Agriculture - Dam Terminology
...
#Retrieving Document
############################################################################
document = Document('ks-doa-dt.docx')
...
glossary.to_excel('ks-doa-dt_EXPORT.xlsx')  #ToDo: un-comment to run again
